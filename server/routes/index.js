...
/* GET home page. */
router.get(/^\/(index|plan|planDetail|uc|test|practice|practiceShare|read|appointment|testLand|testShare|paid|badge|wordList|handout|mailBox)?$/, function (req, res, next) {
